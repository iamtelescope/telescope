...
class DummySource(Source):
    """A minimal Source subclass for testing."""
    def __init__(self, conn_data):
        # The real Source expects many attributes; we only need those used by the fetcher.
        self.conn = MagicMock()
...
class TestKubernetesFetcher(unittest.TestCase):
    ...
    @patch("kubernetes.fetcher.client.CoreV1Api")
    ...
    def test_fetch_data_simple(self, mock_api):
        ...
        response = Fetcher.fetch_data(request, _timezone="UTC")
