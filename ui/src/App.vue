<template>
            ...
            <div class="flex flex-col h-full">
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-col" style="height: 100%; padding-top: 15px">
                        <Menu
                            :model="sidebarItems"
                            pt:root:style="border-left:none;border-right: none; border-radius: 0px;"
                        />
                    </div>
                </div>
            </div>
    ...
    <div class="flex flex-row align-items-stretch w-full h-full" v-if="isLoggedIn">
        <div class="flex flex-col items-start w-full h-full">
            <div
                class="flex flex-row w-full items-center pl-2 pt-2 pb-2 border-b border-neutral-300 dark:border-neutral-600"
            >
                ...
                <div class="flex flex-row w-full justify-end items-center mr-4">
                    ...
                    <Button
                        ...
                        aria-haspopup="true"
                        aria-controls="overlay_manage_menu"
                    />
                    <Avatar
                        v-if="user.avatarUrl"
