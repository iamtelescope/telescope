<template>
  <div class="flex flex-row">
    <div class="text-3xl font-bold pl-6 pt-6 pb-0 text-nowrap"><span v-if="!view">Create new view</span><span v-else>Update view</span>
    </div>
    ...
    <div class="flex flex-col h-full">
      <div class="flex flex-col w-full">
        <div class="flex flex-col gap-2">
          ...
          <Select v-model="selectedScope" :options="scopes" optionLabel="label" placeholder="Select scope"
                  class="w-full" :disabled="!source.isEditable()">
      ...
      <div class="flex flex-col w-full mt-4">
        <div class="flex flex-col gap-2">
          ...
          <Textarea id="description" v-model="description" rows="8" cols="30" style="resize: none"
      ...
      <Message v-if="nonFieldErrors.length !== 0" class="mt-2" severity="error"><span class="font-medium">Validation failed: </span>{{
          nonFieldErrors.join(" ")
        }}
      </Message>
      <div class="flex flex-col h-full justify-end">
        <div class="flex flex-row mt-4 w-full justify-end">
          <Button label="Cancel" severity="primary" class="mr-2" text size="small"
                  :disabled="submitButtonLoading" @click="emitClose"/>
          <Button :label="submitButtonLabel" severity="primary" icon="pi pi-check" size="small"
