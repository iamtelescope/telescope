<template>
    <div class="flex flex-col w-full">
        <Fieldset class="text-wrap">
            ...
            <div class="flex flex-col w-full">
                <div class="flex flex-col w-full">
                    <FloatLabel variant="on">
                        <Select
                            id="time_field"
                            optionLabel="name"
                            v-model="formData['time_field']"
                            :invalid="formErrors['time_field'] != ''"
                            fluid
                            editable
                            :options="sourceStaticFieldChoices['time_field']"
                            optionValue="name"
                            showClear
                        />
                ...
                <div class="flex flex-col w-full mt-4">
                    <FloatLabel variant="on">
                        <Select
                            ...
                            :invalid="formErrors['date_field'] != ''"
                            fluid
                            editable
                            :disabled="!settings.fields.date.editable"
                            :options="sourceStaticFieldChoices['date_field']"
                            optionValue="name"
                            showClear
                        />
                        <label for="date_field">Date field</label>
                    </FloatLabel>
                    <ErrorText :text="formErrors['date_field']" />
                </div>
                <div class="flex flex-col w-full mt-4">
                    <FloatLabel variant="on">
                        <Select
                            id="severity_field"
                            optionLabel="name"
                            v-model="formData['severity_field']"
                            :invalid="formErrors['severity_field'] != ''"
                            fluid
                            editable
                            :disabled="!settings.fields.severity.editable"
                            :options="sourceStaticFieldChoices['severity_field']"
                            optionValue="name"
                            showClear
                        />
                ...
                <div class="flex flex-col w-full mt-4">
                    <FloatLabel variant="on">
                        <InputText
                            id="default_chosen_fields"
                            v-model="formData['default_chosen_fields']"
                            fluid
                ...
                <div class="flex flex-row justify-end mb-6 mt-7">
                    <Button
                        ...
                        severity="primary"
                        icon="pi pi-download"
                        label="Load fields from schema"
                        size="small"
                        @click="handleLoadSourceDynamicFieldsFromSchema"
                    ...
                    <Button
                        ...
                        v-if="settings.allowAddManualFields"
                    />
                </div>
                ...
                <BorderCard v-for="field in sourceDynamicFieldsList" :key="field.name" class="mb-4 pb-2 pl-4 pr-4">
                    ...
                    <div class="flex flex-row w-full items-center mb-4">
                        ...
                        <div class="flex flex-col pl-6 w-96">
                            <InputText
                                :id="field.name + '_display_name'"
                                v-model="formData['fields'][field.name]['display_name']"
                                :invalid="dynamicFieldHasError(field.name, 'display_name')"
                                fluid
                            />
                    ...
                    <div class="flex flex-row w-full items-center mb-4">
                        ...
                        <div class="flex flex-col pl-6 w-96">
                            <Select
                                :id="field.name + '_type'"
                                fluid
                                v-model="formData['fields'][field.name]['type']"
                                :options="sourceDynamicFieldTypes"
                                :invalid="dynamicFieldHasError(field.name, 'type')"
                                editable
                                filter
                                autoFilterFocus
                            />
                    ...
                    <div class="flex flex-row w-full items-center mb-4">
                        ...
                        <div class="flex flex-col pl-6 w-96">
                            <InputText
                                ...
                                v-model="formData['fields'][field.name]['values']"
                                :invalid="dynamicFieldHasError(field.name, 'values')"
                                fluid
                            />
        ...
        <Dialog
            v-model:visible="newSourceDynamicFieldDialogData.visible"
            modal
            header="Add field"
            :style="{ width: '25rem' }"
        >
            <div class="flex items-center mb-4">
                <div class="flex flex-col w-full">
                    <FloatLabel variant="on" :invalid="newSourceDynamicFieldDialogData.invalid">
                        <InputText
                            id="new_name"
                            v-model="newSourceDynamicFieldDialogData.value"
                            fluid
            ...
            <div class="flex justify-end gap-2">
                <Button
                    ...
                    label="Cancel"
                    severity="secondary"
                    @click="handleNewDynamicFieldDialogClose"
                ></Button>
...
const props = defineProps(['source', 'kind', 'schemaFields', 'connectionData', 'formErrors', 'settings'])
...
const getInitialFormData = () => {
    ...
    if (props.source) {
        ...
        data.date_field = props.source.dateField
