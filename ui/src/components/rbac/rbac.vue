        ...
        <div class="flex flex-wrap justify-start min-w-1280 max-w-1280 gap-2">
            <div class="w-full">
                <div class="flex flex-col w-full mb-14 align-middle">
                    <span class="font-bold text-3xl"><i class="pi pi-shield text-3xl"></i> Role-Based Access Control</span>
                    <span class="text-gray-400">Helps manage permissions
                         by assigning roles to users and groups,<br>ensuring efficient and secure access control
            ...
            <Card class="max-w-400 cursor-pointer hover:drop-shadow-md dark:drop-shadow-md dark:hover:drop-shadow-xl" @click="handleRolesClick">
                ...
                <template #content>
                    Roles determine the access levels and permissions assigned to users, 
            ...
            <Card class="max-w-400 cursor-pointer hover:drop-shadow-md dark:drop-shadow-md dark:hover:drop-shadow-xl" @click="handleGroupsClick">
                ...
                <template #content>
                    Groups let you manage permissions and access for teams within
            ...
            <Card class="max-w-400 cursor-pointer hover:drop-shadow-md dark:drop-shadow-md dark:hover:drop-shadow-xl" @click="handleUsersClick">
                ...
                <template #content>
                    Users are members of your organization with specific
                    permissions that control their access and actions
                </template>
            </Card>
        </div>
    </div>
...
navStore.update([
    { label: 'Role-Based Access Control', url: '/rbac', class: "text-gray-100" },
])
